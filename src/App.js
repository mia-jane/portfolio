  ...
  return (
    <div className="App">
        ...
        <div className="projectsDisplay">
          <a className="card"href="https://reading-book-tracking.herokuapp.com/" target="_blank" rel="noopener noreferrer">
              <div className="overlay"></div>
              <h2 className="projectName">Reading List</h2>
              <img className="projectImage" src={booklist} alt="book list" />
          </a>
          <a className="card"href="https://github.com/mia-jane/quote-api" target="_blank" rel="noopener noreferrer">
              <div className="overlay"></div>
              <h2 className="projectName">Advice API</h2>
              <img className="projectImage" src={advicepicture} alt="advice picture" />
          </a>
          <a className="card"href="https://github.com/mia-jane/blog-theme-mockup" target="_blank" rel="noopener noreferrer">
              <div className="overlay"></div>
              <h2 className="projectName">Clean Blog Theme</h2>
              <img className="projectImage" src={blogtheme} alt="clean blog theme" />
          </a>
        </div>
        <footer className="footer">
          <div className="footer-content" >
            ...
            <a className="email-link" target="_blank" href="mailto:miast36@gmail.com">miast36@gmail.com</a>
          </div>
        </footer>
      </div>
  );
